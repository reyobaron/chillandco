...
const translations = {
  en: {
    ...
    "news.item1.title": "Signature presentations that turn every order into an experience",
  ...
  bs: {
    ...
    "news.item1.title": "Prepoznatljive prezentacije koje svaku narudzbu pretvaraju u iskustvo",
